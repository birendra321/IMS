...
class saleClass:
    def __init__(self, root):
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("times new roman",15,"bold"),bg="lightgreen",fg="white",cursor="hand2").place(x=490,y=100,width=120,height=28)
