...
class productClass:
    def __init__(self, root):
        ...
        lbl_spplier=Label(product_Frame,text="Supplier",font=("goudy old style",18),bg="white").place(x=30,y=110)
    ...
    def update(self):
        ...
        try:
            if self.var_pid.get()=="":
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","Ivalid product ", parent=self.root)
                else:
