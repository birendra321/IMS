...
class employeeClass:
    def __init__(self, root):
        ...
        lbl_contact=Label(self.root,text="Contect",font=("goudy old style",15),bg="white").place(x=750,y=150)
       ...
       #====row 2 =====
        ...
        txt_slary=Entry(self.root,textvariable=self.var_salary,font=("goudy old style",15),bg="lightyellow").place(x=600,y=270,width=180)

        #=== buttons =====
        btn_add=Button(self.root,text="Save", command=self.add,font=("goudy old style",15),bg="#2196f3",fg="red",cursor="hand2").place(x=500, y=305,width=110,height=28)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),bg="yellow",fg="white",cursor="hand2").place(x=620, y=305,width=110,height=28)
